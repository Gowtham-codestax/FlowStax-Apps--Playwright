/**
 * Source (Java): testsScriptKBZPayService.Pin_Reset_Req_Device_Change_ReqTest
...
test.describe.serial('Pin_Reset_Req_Device_Change_Req', () => {
  ...
  // priority 1
  test('Pin_Reset_Req_Device_Change_ReqPageFlowTest', async () => {
  ...
  // priority 2 - dependsOnMethods = Pin_Reset_Req_Device_Change_ReqPageFlowTest
