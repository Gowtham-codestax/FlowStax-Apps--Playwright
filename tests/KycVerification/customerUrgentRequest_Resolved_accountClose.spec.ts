...
test.describe.serial('CustomerUrgentRequestFlow - Resolved Status( Account Closed )', () => {
 ...
 // 4
  ...
  // 5
 test('KycOfficerFlow - resolved = Status (account Closed)', async () => {
   ...
   await KycOfficer1.accountClosedButton();
