/**
 * Source (Java): testsScriptsCentralOps.Duplicate_Phone_Number_Online_Banking_ApplicationClosedTest
...
test.describe.serial('Duplicate_Phone_Number_Online_Banking_ApplicationClosed', () => {
  ...
  // priority 1
  test('Duplicate_Phone_Number_Online_Banking_applicationClose_FlowTest', async () => {
  ...
  // priority 2 - dependsOnMethods = Duplicate_Phone_Number_Online_Banking_applicationClose_FlowTest
  test('CFI_Flow', async () => {
    const login = new LoginPage(page);
    const Kyc = new KYCPage(page);
