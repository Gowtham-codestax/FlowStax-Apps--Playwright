...
test.describe.serial('KYC Update - EscalateFlow', () => {
  ...
  // 2
  test('kyc1Cops - Start Action and Update Button ', async () => {
  ...
  // 3
  test(' SAO Login  - Application Corrected', async () => {
  ...
  // 4
  test('kyc1Cops  - Update Button ', async () => {
  ...
  // 5
  test('kyc2Cops  - ReWork Button', async () => {
  ...
  // 6
  test('kyc1Cops  - ReWork Complete Button', async () => {
  ...
  // 7
  test('kyc2Cops - Complete Button', async () => {
