...
test.describe.serial('Company KYC Update - Request Closure (Closed Appliation)', () => {
 ...
 test.beforeAll( async ({browser}) => {
   ...
   test('Company KYC Update - Branch ', async()=>{
    ...
    //4
    test(' Admin Login - Closed Application ', async()=>{
    ...
    //5
    test('Branch Flow - To check the status of the [Complete Kyc Update - Closed Application]', async()=>{
