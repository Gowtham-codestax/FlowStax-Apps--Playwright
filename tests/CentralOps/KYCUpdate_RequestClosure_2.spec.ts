...
test.describe.serial('KYC Update - Request Closure (Wrong Application) - Application Closed', () => {
  ...
  test('kyc1Cops Login - Mark For Correction', async () => {
   ...
   // 3
  test('branchTeam  - Request For Closure -Wrong Application', async () => {
    ...
    await Kyc.wrongapplication_Option();
  ...
  // 4
  test('Admin Login - For Close Application', async () => {
