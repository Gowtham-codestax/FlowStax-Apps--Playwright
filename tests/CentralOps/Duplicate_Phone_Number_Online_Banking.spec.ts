/**
 * Source (Java): testsScriptsCentralOps.Duplicate_Phone_Number_Online_BankingTest
...
test.describe.serial('Duplicate_Phone_Number_Online_Banking', () => {
  ...
  // priority 1
  test('Duplicate_Phone_Number_Online_BankingFlowTest', async () => {
  ...
  // priority 2 - dependsOnMethods = Duplicate_Phone_Number_Online_BankingFlowTest
  test('CFI_Flow', async () => {
    const login = new LoginPage(page);
    const Kyc = new KYCPage(page);
